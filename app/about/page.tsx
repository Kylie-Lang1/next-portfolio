			...
			{/* <h1 className={title()}>About</h1> */}
				<div className="flex flex-row gap-x-4 mt-6">
					<section className="w-1/3">
						...
						<p className="mt-4 px-10">I am excited to apply my acquired skills, explore my creativity and continue learning new software developemnt skills to further my career.</p>
					</section>
							...
							<div className="flex flex-col gap-8 text-left bg-white dark:bg-black w-full rounded-2xl h-[80%] overflow-hidden">
								<div className="ml-10 my-8 flex flex-col gap-y-5 text-sm">
									<div>
										...
										<p>Jun 2020 - Present (3+ years)</p>
									</div>
									<div>
										<h3>Enumerator</h3>
										<p>U.S. Census Bureau</p>
										<p>Aug 2020 - Oct 2020 (Temp)</p>
									</div>
									<div>
										<h3>Veterinary Assistant</h3>
										<p>145th Street Animal Hospital</p>
										<p>Aug 2016 - Mar 2020 (4+ years)</p>
									</div>
									<div>
										<h3>Assistant Coordinator of Discovery Guide Program</h3>
										<p>WCS Queens Zoo</p>
										<p>Jun 2018 - Aug 2018 (Seasonal)</p>
									</div>
									<div>
										<h3>Sales Associate</h3>
										<p>American Eagle Outfitters</p>
										<p>Jun 2016 - Aug 2016 (Temp)</p>
									</div>
									<div>
										<h3>Assistant Tennis Coach</h3>
										<p>New York Junior Tennis & Learning</p>
										<p>Jun 2014 - Aug 2015 (1 year)</p>
									</div>
									<div>
										<h3>Volunteer Event Server</h3>
										<p>Church of the Resurrection</p>
										<p>Oct 2012 - May 2014 (2 years)</p>
									</div>
								</div>
							</div>
						</ScrollShadow>
